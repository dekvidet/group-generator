    ...
    <>
      {(generatedIdCount > 0 || duplicateRowCount > 0) && (
        <Alert severity="warning" sx={{ marginBottom: '20px' }}>
          ...
          <ul>
            {generatedIdCount > 0 && <li>{t('mapColumns.texts.generatedIds', { count: generatedIdCount })}</li>}
            {duplicateRowCount > 0 && <li>{t('mapColumns.texts.removedDuplicates', { count: duplicateRowCount })}</li>}
          </ul>
        </Alert>
      )}
